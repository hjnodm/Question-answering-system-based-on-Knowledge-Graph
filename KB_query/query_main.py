...
#from KB_query import jena_sparql_endpoint, question2sparql
import os
...
class QAInterface:
    def __init__(self):
        ...
        self.q2s = question2sparql.Question2Sparql([os.path.join(file_path, 'external_dict', 'movie_title.txt'),
                                                    ...
                                                    os.path.join(file_path, 'external_dict', 'roommate_name.txt'),
                                                    os.path.join(file_path, 'external_dict', 'proper_noun_title.txt'),
                                                    ])
